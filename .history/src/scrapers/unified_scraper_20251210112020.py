#!/usr/bin/env python3
"""
Unified Legal Scraper 2025
Генерирует:
1. raw/        → полный текст статей (для дистилляции)
2. processed/  → чистые {"case": "...", "article": "72"} (для fine-tune / few-shot)
3. distilled/  → тысячи синтетических кейсов через teacher model (опционально)
"""
